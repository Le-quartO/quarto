...
suiv = pygame.image.load("boutonsuivant.png").convert_alpha()
...
suivrect=pygame.Rect(1000,617,127,44)
...
piecerect9=pygame.Rect(755,15,95,99)


fenetre.blit(reset,resetrect)
fenetre.blit(suiv,suivrect)
        ...
        for event in pygame.event.get():   #On parcours la liste de tous les événements reçus
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if pygame.mouse.get_pos()[0] >= 755 and pygame.mouse.get_pos()[1] >= 15 and pygame.mouse.get_pos()[0] <= 860 and pygame.mouse.get_pos()[1]<=105 and p9==2:
                        p9=1
                    ...
                    if pygame.mouse.get_pos()[0] >= 1140 and pygame.mouse.get_pos()[1] >= 617 and pygame.mouse.get_pos()[0] <= 1302 and pygame.mouse.get_pos()[1]<=767:
                        ...
                        piecerect7=pygame.Rect(1020,10,100,50)
                        piecerect8=pygame.Rect(870,10,100,50)
                        piecerect9=pygame.Rect(755,10,95,99)
